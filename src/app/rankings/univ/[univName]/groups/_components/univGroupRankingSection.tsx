...
import type { Column, Query, Tier } from "@/types";
...
export default function UnivGroupRankingSection({
  ...
  const [query, setQuery] = useState<Query>({ groupNameKey: "" });
  ...
  return (
    <div className="flex flex-col space-y-4 w-full">
      ...
      <RankingTable
        APIURL={`/rankings/univ/${univName}/groups`}
        query={query}
        columns={
          [
            {
              ...
              cell: (row) => (
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="flex">
                      <span>
                        {capitalize(row.avgTierInfo.tier.toLowerCase())}
                      </span>
